...
function openPopview(e){
  ...
  if( e == "Alert"){
    ...
    $("#pop-alert").clone().appendTo(".popview").attr("xkID",currentID );
    ...
    $("#pop-actionSheet").clone().appendTo(".popview").attr("xkID",currentID );
    ...
    $("#pop-picker").clone().appendTo(".popview").attr("xkID",currentID );
