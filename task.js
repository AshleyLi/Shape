...
var taskIndex1 = [99, 0,1,13,3,8,9,15,10,2,5,12,11,4,7,14,6,  34,31,32,19,29,22,28,27,18,25,21,17,26,16,20,33,23,30,24];
var taskIndex2 = [99, 3,6,14,10,12,4,13,1,0,8,11,2,9,7,5,15,  31,17,33,28,22,29,18,27,34,26,20,32,21,23,24,30,25,19,16];
var taskIndex3 = [99, 2,13,0,9,10,6,1,8,5,4,11,15,12,3,14,7,  24,16,34,28,26,31,22,23,20,27,33,17,21,29,25,32,18,30,19];
var taskIndex4 = [99, 8,12,4,5,0,14,1,15,7,3,2,11,10,13,6,9,  18,19,31,26,34,30,27,29,32,23,28,33,22,25,17,24,20,16,21];
var taskIndex5 = [99, 9,2,11,6,0,15,12,8,4,5,10,14,13,7,3,1,  20,31,16,25,24,26,23,17,21,33,22,30,32,29,19,27,34,18,28];
var taskIndex6 = [99, 7,4,11,1,5,8,9,6,15,10,14,2,0,3,12,13,  27,23,19,22,26,32,17,30,25,29,18,31,34,21,28,33,20,24,16];
var taskIndex7 = [99, 1,13,7,0,6,8,10,12,2,5,9,11,14,3,4,15,  20,16,22,28,33,24,30,32,19,18,23,29,31,17,27,25,21,34,26];
...
$(document).ready(function() {
  ...
  // }
  // (一)設定任務
  studyTask = taskIndex7; //****************************************(ＴＡＳＫ ＳＥＴＴＩＮＧ)****************************************
